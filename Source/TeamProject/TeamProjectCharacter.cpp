...
void ATeamProjectCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("ReadyFire", IE_Pressed, this, &ATeamProjectCharacter::ReadytoFire);
	PlayerInputComponent->BindAction("ReadyFire", IE_Released, this, &ATeamProjectCharacter::ReleasetoFire);
}
...
void ATeamProjectCharacter::ReadytoFire()
{
	bReadyFire = true;
	bUseControllerRotationYaw = true;
	GetCharacterMovement()->bOrientRotationToMovement = false;
	CameraBoom->SetRelativeLocation(FVector(50.f, 130.f, 100.f));
	CameraBoom->TargetArmLength = 150.f;
}

void ATeamProjectCharacter::ReleasetoFire()
{
	bReadyFire = false;
	bUseControllerRotationYaw = false;
